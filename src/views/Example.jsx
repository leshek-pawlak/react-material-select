...
class Example extends Component {
    constructor() {
        ...
        this.callbackFunction4 = this.callbackFunction4.bind(this)
        this.resetSelect = this.resetSelect.bind(this)
        this.getDefaultValueFromExample3 = this.getDefaultValueFromExample3.bind(this)
        this.getDefaultValueFromExample4 = this.getDefaultValueFromExample4.bind(this)
    }
    ...
    // get default value from select, after it shows in DOM
        ...
        if (this.refs.extrafeature) {
            this.getDefaultValueFromExample4()
        }
    }
    ...
    setSelect(label, value) {
        this.refs.extrafeature.handleSetSelect(label, value)
    }
    ...
    callbackFunction4(selected) {
        this.setState({selected4: selected})
    }
    ...
    getDefaultValueFromExample4() {
        if (this.refs.extrafeature) {
            this.setState({
                selected4: {
                    value: this.refs.extrafeature.getValue(),
                    label: this.refs.extrafeature.getLabel(),
                },
            })
        }
    }
  ...
  // function to render object values
    ...
    this.refs.lastselect.handleResetSelect()
            ...
            case 'example4':
              ...
              <section id="example4">
                <h3>Extra feature</h3>
                <h5>We can set every label and value we want!</h5>
                <h6>We need to invoke this.handleSetSelect method with label and value parameters.</h6>

                <ReactMaterialSelect label="Choose best character from Harry Potter saga" ref="extrafeature" defaultValue="Harry Potter" resetLabel={false} onChange={this.callbackFunction4}>
                  <option dataValue="Herimiona Grenger">Herimiona Grenger</option>
                  <option dataValue="Ron Weasley">Ron Weasley</option>
                  <option dataValue="Harry Potter">Harry Potter</option>
                  <option dataValue="Draco Malfoy">Draco Malfoy</option>
                  <option dataValue="Minerva McGonagal">Minerva McGonagal</option>
                  <option dataValue="Albus Percival Wulfric Brian Dumbledore">Albus Percival Wulfric Brian Dumbledore</option>
                </ReactMaterialSelect>

                <button className="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised" type="button" raised ripple onClick={() => this.setSelect('Voldemort', 'Voldemort')}>Voldemort!</button>

                {this.renderResponse(this.state.selected4)}
      ...
      ...
                ...
                <h6>It is possible to set value and label which aren't on the options list!</h6>
